...
@router.get ("/todo", response_model=List[ToDo], status_code=200)
...
@router.get ("/todo/{id}", response_model=ToDo, status_code=status.HTTP_200_OK)
...
@router.put ("/todo/{id}", response_model=ToDo, status_code=status.HTTP_200_OK)
...
if __name__ == "__main__":
    uvicorn.run ("main:router", host="127.0.0.1", port=8000, reload=True)
